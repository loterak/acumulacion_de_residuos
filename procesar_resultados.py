...
recorridos = ["A_DU_RM_CL_101", "A_DU_RM_CL_102", "A_DU_RM_CL_103", "A_DU_RM_CL_104", "A_DU_RM_CL_105", "A_DU_RM_CL_106", "A_DU_RM_CL_107", "A_DU_RM_CL_108", 
...
# Cantidad de días totales con contenedores desbordados por barrio
# Para cada contenedor: asociarle cantidad de días de atraso totales, atraso máximo, cantidad de atrasos
# Asociar contenedores con el barrio (para el qgis)
